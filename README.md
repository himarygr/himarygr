...
Владею **Python** и  **SQL** на продвинутом уровне, есть навыки построения **ML-моделей**, с использованием библиотек **Keras,  Catboost,  Scikit-learn,  Pandas.**
Здесь вы найдете мои исследования и проекты, связанные с наукой о данных.
    </p>
